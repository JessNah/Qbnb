...
<body>
 ...
 if(isset($_POST['updateBtn']) && isset($_SESSION['id'])){
  // include database connection
	...
	$query = "UPDATE service_member SET password=?,email=? WHERE id=?";
...
if(isset($_SESSION['id'])){
   // include database connection
	...
	// SELECT query
        $query = "SELECT id, username, password, email FROM service_member WHERE id=?"; 
...
?>
 Welcome  <?php echo $myrow['username']; ?>, <a href="login.php?logout=1">Log Out</a><br/>
